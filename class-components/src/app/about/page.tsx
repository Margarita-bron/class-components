...
export default function AboutUsPage() {
  return (
    <div
      className={classes(
        'relative isolate bg-white px-6 py-24 dark:bg-black sm:py-32 lg:px-8'
      )}
    >
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          className="aspect-1155/678 w-288.75 bg-linear-to-tr mx-auto from-[#ff80b5] to-[#9089fc] opacity-30"
        />
      </div>
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p
          className={classes(
            'mt-2 text-balance text-6xl font-semibold tracking-tight text-gray-900 dark:text-gray-400 sm:text-6xl'
          )}
        >
          Our Collaboration
        </p>
      ...
      <p
        className={classes(
          'mx-auto mt-6 max-w-2xl text-pretty text-center text-lg font-medium text-gray-600 dark:text-gray-500 sm:text-xl/8'
        )}
      >
